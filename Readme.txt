...
*) The script creation could also be further eased by making use of "AIBE Editor" (https://github.com/ian5666987/AIBE_Editor.git)- the editor I create specifically to write AIBE scripts with minimal effort.
...
*) Please find my AIDE (ASTrio In-house-built Desktop Engine) project (https://github.com/ian5666987/AIDE.git) for an example of such GUI project for desktop application. 
